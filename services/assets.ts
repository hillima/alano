...
export const userAssets = async ({ name }) => {
...
export const userUnAssets = async ({ name }) => {
  const data = await axios.post(`/api/unassets`, {
    data: {
      user: name
    }
  })
...
export const userCreatedAssets = async ({ author }) => {
  const data = await axios.post(`/api/create/assets`, {
    data: {
      name: author
    }
  })
...
export const userCreatedUnAssets = async ({ author }) => {
  const data = await axios.post(`/api/create/unassets`, {
    data: {
      name: author
    }
  })
